...
$jscomp.polyfill(
  ...
  function (e) {
    ...
    c.race = function (b) {
      return new c(function (a, f) {
        for (
          var k = $jscomp.makeIterator(b), d = k.next();
          !d.done;
          d = k.next()
        )
      ...
      return f.done
        ...
        : new c(function (b, d) {
            ...
            do
              c.push(void 0),
                e++,
                g(f.value).callWhenSettled_(k(c.length - 1), d),
                (f = a.next());
            while (!f.done);
          });
    };
...
var Zebra = (function () {
  ...
  g.Printer = function (c) {
    ...
    g.Printer.Configuration = function (a) {
      ...
      this.printSpeed = parseInt(
        this.settings["PRINT SPEED"].replace("IPS", "").trim()
      );
